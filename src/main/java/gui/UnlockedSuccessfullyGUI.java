...
public class UnlockedSuccessfullyGUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UnlockedSuccessfullyGUI window = new UnlockedSuccessfullyGUI();
	 ...
	 */
	public UnlockedSuccessfullyGUI() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblFolderLockedSuccessfully = new JLabel("Folder Unlocked Successfully");
		...
		URL iconURL1 = getClass().getResource("/Unlock.png");
		ImageIcon icon = new ImageIcon(iconURL1);
		JLabel label = new JLabel(icon);
		label.setBounds(140, 75, 127, 122);
